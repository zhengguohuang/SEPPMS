            ...
            <div class="">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" action="/user/doEditProfile">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="cemail" type="email" class="form-control" name="email" required="" aria-required="true" value="${user.email}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">专长：</label>
                                <div class="col-sm-8">
                                    <input id="curl" type="text" class="form-control" name="specialty" value="${user.specialty}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">爱好：</label>
                                <div class="col-sm-8">
                                    <input id="ccomment" name="hobby" class="form-control" required="" aria-required="true" value="${user.hobby}"></input>
                                </div>
                            </div>
                            <div class="form-group">
