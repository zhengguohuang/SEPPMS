            ...
            <div class="">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="commentForm" action="/user/doChangePassword">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">新密码：</label>
                                <div class="col-sm-8">
                                    <input  name="password1" minlength="2" type="password" class="form-control"  aria-required="true" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="code" minlength="2" type="text" class="form-control"  aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
