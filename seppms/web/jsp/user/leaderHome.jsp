        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <%--<c:forEach items="${relations}" var="r">--%>
                    <%--<li>--%>
                        <%--<a class="J_menuItem" href='<c:url value="${r.menu.url}"/> '><i class="fa ${r.menu.icon}"></i> <span class="nav-label">${r.menu.name}</span></a>--%>
                    <%--</li>--%>
                <%--</c:forEach>--%>
                <li>
                ...
                <li>
                    <a class="J_menuItem" href='<c:url value="/group/toMemberList"/> '><i class="fa fa-tasks"></i> <span class="nav-label">分配任务</span></a>
                </li>
                <li>
                    <a href="#">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href='<c:url value="/info/graphMark"/> '>我的成绩</a>
                        </li>
