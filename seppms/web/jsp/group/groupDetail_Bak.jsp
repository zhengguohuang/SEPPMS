                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <dl class="dl-horizontal">
                                    <dt>状态：</dt>
                                    <dd><span class="label label-primary">${group.status}</span>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                                    ...
                                    <div class="panel-heading">
                                        <div class="panel-options">
                                            <ul class="nav nav-tabs">
                                                <li><a href="groupDetail.jsp#tab-1" data-toggle="tab">团队消息</a>
                                                </li>
                                                <li class=""><a href="groupDetail.jsp#tab-2" data-toggle="tab">最后更新</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <div class="col-sm-3">
            <div class="wrapper wrapper-content project-manager">
                ...
                <ul class="tag-list" style="padding: 0">
                    <li><a href="groupDetail.jsp"><i class="fa fa-tag"></i> 文档</a>
                    </li>
                    <li><a href="groupDetail.jsp"><i class="fa fa-tag"></i> 分享</a>
                    </li>
                    <li><a href="groupDetail.jsp"><i class="fa fa-tag"></i> 下载</a>
                    </li>
                </ul>
                <h5>项目文档</h5>
                <ul class="list-unstyled project-files">
                    <li><a href="groupDetail.jsp"><i class="fa fa-file"></i> Project_document.docx</a>
                    </li>
                    <li><a href="groupDetail.jsp"><i class="fa fa-file-picture-o"></i> Logo_zender_company.jpg</a>
                    </li>
                    <li><a href="groupDetail.jsp"><i class="fa fa-stack-exchange"></i> Email_from_Alex.mln</a>
                    </li>
                    <li><a href="groupDetail.jsp"><i class="fa fa-file"></i> Contract_20_11_2014.docx</a>
                    </li>
                </ul>
                <div class="m-t-md">
                    <a href="groupDetail.jsp#" class="btn btn-xs btn-primary">添加文档</a>
