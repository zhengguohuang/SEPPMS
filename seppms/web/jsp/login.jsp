        ...
        <div>
            ...
            <form class="m-t" role="form" action="/home">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="学号/工号" name="number" required="">
                </div>
                <div class="form-group">
                ...
                <p class="text-muted text-center"> <a href='<c:url value="/user/toForgetPassword" />'><small>忘记密码了？</small></a> | <a href='<c:url value="/user/toRegPage" />'>注册一个新账号</a>
                </p>
