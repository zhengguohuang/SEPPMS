...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                    ...
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               ...
                               <span class="block m-t-xs"><strong class="font-bold">${user.name}</strong></span>
                                <span class="text-muted text-xs block">${user.roleId}<b class="caret"></b></span>
                                </span>
                        </a>
                ...
                <li>
                    <a class="J_menuItem" href="groups.html"><i class="fa fa-group"></i> <span class="nav-label">小组</span></a>
                </li>
                <li>
                    <a href="#">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="empty_page.html" frameborder="0" data-id="empty_page.html" seamless></iframe>
        </div>
        <div class="footer">
